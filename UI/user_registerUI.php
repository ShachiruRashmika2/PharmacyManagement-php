...
<body class="bg-gray-100 flex items-center justify-center min-h-screen  bg-[url('./Assets/medical-bandages-pills-with-copy-space.jpg')] bg-cover bg-center">
  ...
  <form method="POST" action="../PHP/register.php" class="glass p-8 rounded-2xl shadow-lg w-full max-w-md space-y-5">
    ...
    <h2 class="text-2xl font-bold text-center text-sky-800">Register User</h2>
    ...
    <input type="text" name="contactNumber" placeholder="Contact Number"
     class="w-full glass px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm" />
         ...
         <input type="date" name="dob" placeholder="Date of Birth"
          class="w-full glass text-gray-400 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
         />
